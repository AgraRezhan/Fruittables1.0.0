...
module.exports = {
    ...
    async up(queryInterface, _Sequelize) {
        ...
        await queryInterface.bulkInsert("products", [
            ...
            { id: 5, user_id: 4, title: "Stroberi", description: "Buah ini memang kecil, tetapi besar manfaatnya untuk kesehatan tubuh. Dalam 100 gram, ada 56 mg vitamin C yang terkandung.", stock: 50, price: 35000, img_url: "https://cdn.hellosehat.com/wp-content/uploads/2021/03/41e3a6bc-buah-sehat-stroberi-650x434.jpg" },
        ]);
