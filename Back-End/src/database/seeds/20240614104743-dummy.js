...
module.exports = {
    ...
    async up(queryInterface, _Sequelize) {
        ...
        await queryInterface.bulkInsert("users", [
            { id: 1, username: "JohnDoe", first_name: "John", last_name: "Doe", email: "johndoe@gmail.com", password: "Qwerty@123", address: "Jl. Mawar No.3, Bantaeng, Sulawesi Selatan", role: "customer" },
            { id: 2, username: "ErdianFernando", first_name: "Erdian", last_name: "Fernando", email: "erdianfernando@gmail.com", password: "Qwerty@123", address: "Jl. Mawar No.3, Bantaeng, Sulawesi Selatan", role: "seller" },
        ]);
