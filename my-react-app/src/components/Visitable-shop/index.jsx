    ...
    <div className="container-fluid vesitable py-5">
      <div className="container py-5">
        ...
        <OwlCarousel className="owl-carousel vegetable-carousel justify-content-center" >
          <div
            className="me-3 me-3 border border-primary rounded position-relative vesitable-item"
          >
          ...
          <div
            className="me-3 border border-primary rounded position-relative vesitable-item"
          >
            <div className="vesitable-img">
              <img
